...
LICENSE="GPL-2"
SRC_URI="http://bitbucket.org/bearsh/bearshoverlay/downloads/${P}.tar.bz2"
...
DEPEND="
        ...
        openvpn? ( >=net-misc/networkmanager-openvpn-0.7.0 )
...
src_unpack() {
        ...
        epatch "${FILESDIR}/01-configure_package_name.patch"
        epatch "${FILESDIR}/05-no_blank_psk.patch"
...
src_install() {
        ...
        #doins "${FILESDIR}/knetworkmanager.desktop"
}
